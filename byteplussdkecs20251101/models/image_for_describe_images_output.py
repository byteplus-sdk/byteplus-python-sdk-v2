...
class ImageForDescribeImagesOutput(object):
    ...
    def __init__(self, boot_mode=None, created_at=None, description=None, image_id=None, image_name=None, os_name=None, os_type=None, platform=None, platform_version=None, project_name=None, size=None, status=None, tags=None, updated_at=None, visibility=None, _configuration=None):  # noqa: E501
