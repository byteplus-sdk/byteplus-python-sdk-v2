...
class ImportImageRequest(object):
    ...
    def __init__(self, boot_mode=None, description=None, image_name=None, platform=None, platform_version=None, project_name=None, tags=None, url=None, _configuration=None):  # noqa: E501
