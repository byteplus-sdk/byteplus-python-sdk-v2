...
class NetworkForDescribeInstanceTypesOutput(object):
    ...
    def __init__(self, baseline_bandwidth_mbps=None, maximum_bandwidth_mbps=None, maximum_network_interfaces=None, maximum_private_ipv4_addresses_per_network_interface=None, _configuration=None):  # noqa: E501
