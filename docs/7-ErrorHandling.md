...
| `2. Client Error` | Parameter/authentication errors before reaching the server | `byteplussdkcore.rest.ApiException` `ValueError` | Client-side parameter validation |
