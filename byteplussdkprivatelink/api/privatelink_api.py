...
class PRIVATELINKApi(object):
    ...
    def describe_cross_region_supported_regions(self, body, **kwargs):  # noqa: E501
        """describe_cross_region_supported_regions  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.describe_cross_region_supported_regions(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param DescribeCrossRegionSupportedRegionsRequest body: (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.describe_cross_region_supported_regions_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.describe_cross_region_supported_regions_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def describe_cross_region_supported_regions_with_http_info(self, body, **kwargs):  # noqa: E501
        """describe_cross_region_supported_regions  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.describe_cross_region_supported_regions_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method describe_cross_region_supported_regions" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if self.api_client.client_side_validation and ('body' not in params or
                                                       params['body'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body` when calling `describe_cross_region_supported_regions`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/DescribeCrossRegionSupportedRegions/2020-04-01/privatelink/get/text_plain/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='DescribeCrossRegionSupportedRegionsResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def describe_cross_region_supported_zones(self, body, **kwargs):  # noqa: E501
        """describe_cross_region_supported_zones  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.describe_cross_region_supported_zones(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param DescribeCrossRegionSupportedZonesRequest body: (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.describe_cross_region_supported_zones_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.describe_cross_region_supported_zones_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def describe_cross_region_supported_zones_with_http_info(self, body, **kwargs):  # noqa: E501
        """describe_cross_region_supported_zones  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.describe_cross_region_supported_zones_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method describe_cross_region_supported_zones" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if self.api_client.client_side_validation and ('body' not in params or
                                                       params['body'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body` when calling `describe_cross_region_supported_zones`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/DescribeCrossRegionSupportedZones/2020-04-01/privatelink/get/text_plain/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='DescribeCrossRegionSupportedZonesResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def modify_vpc_endpoint_zone_connection_resource_attributes(self, body, **kwargs):  # noqa: E501
        """modify_vpc_endpoint_zone_connection_resource_attributes  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.modify_vpc_endpoint_zone_connection_resource_attributes(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param ModifyVpcEndpointZoneConnectionResourceAttributesRequest body: (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.modify_vpc_endpoint_zone_connection_resource_attributes_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.modify_vpc_endpoint_zone_connection_resource_attributes_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def modify_vpc_endpoint_zone_connection_resource_attributes_with_http_info(self, body, **kwargs):  # noqa: E501
        """modify_vpc_endpoint_zone_connection_resource_attributes  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.modify_vpc_endpoint_zone_connection_resource_attributes_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method modify_vpc_endpoint_zone_connection_resource_attributes" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if self.api_client.client_side_validation and ('body' not in params or
                                                       params['body'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body` when calling `modify_vpc_endpoint_zone_connection_resource_attributes`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/ModifyVpcEndpointZoneConnectionResourceAttributes/2020-04-01/privatelink/get/text_plain/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='ModifyVpcEndpointZoneConnectionResourceAttributesResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
