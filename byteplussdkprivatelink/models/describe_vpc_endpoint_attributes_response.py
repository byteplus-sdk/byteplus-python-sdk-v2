...
class DescribeVpcEndpointAttributesResponse(object):
    ...
    attribute_map = {
        ...
        'endpoint_zone_nums': 'EndpointZoneNums',
    ...
    def __init__(self, bps=None, business_status=None, connection_status=None, creation_time=None, deleted_time=None, description=None, endpoint=None, endpoint_domain=None, endpoint_id=None, endpoint_index=None, endpoint_name=None, endpoint_type=None, endpoint_zone_nums=None, ip_address_versions=None, ip_address_versions_n=None, payer=None, private_dns_enabled=None, private_dns_name=None, project_name=None, request_id=None, service_id=None, service_managed=None, service_name=None, status=None, tags=None, update_time=None, vpc_id=None, _configuration=None):  # noqa: E501
        ...
        if endpoint_zone_nums is not None:
            self.endpoint_zone_nums = endpoint_zone_nums
    ...
    @property
    def endpoint_zone_nums(self):
        """Gets the endpoint_zone_nums of this DescribeVpcEndpointAttributesResponse.  # noqa: E501


        :return: The endpoint_zone_nums of this DescribeVpcEndpointAttributesResponse.  # noqa: E501
        :rtype: int
        """
        return self._endpoint_zone_nums

    @endpoint_zone_nums.setter
    def endpoint_zone_nums(self, endpoint_zone_nums):
        """Sets the endpoint_zone_nums of this DescribeVpcEndpointAttributesResponse.


        :param endpoint_zone_nums: The endpoint_zone_nums of this DescribeVpcEndpointAttributesResponse.  # noqa: E501
        :type: int
        """

        self._endpoint_zone_nums = endpoint_zone_nums
