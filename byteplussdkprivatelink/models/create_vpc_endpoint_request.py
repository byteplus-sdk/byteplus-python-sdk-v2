...
class CreateVpcEndpointRequest(object):
    ...
    def endpoint_name(self, endpoint_name):
        ...
        """
        if (self._configuration.client_side_validation and
                endpoint_name is not None and len(endpoint_name) > 128):
            raise ValueError("Invalid value for `endpoint_name`, length must be less than or equal to `128`")  # noqa: E501
        if (self._configuration.client_side_validation and
                endpoint_name is not None and len(endpoint_name) < 1):
            raise ValueError("Invalid value for `endpoint_name`, length must be greater than or equal to `1`")  # noqa: E501
