...
class CreateSubnetRequest(object):
    ...
    def __init__(self, cidr_block=None, client_token=None, description=None, subnet_name=None, tags=None, vpc_id=None, zone_id=None, _configuration=None):  # noqa: E501
