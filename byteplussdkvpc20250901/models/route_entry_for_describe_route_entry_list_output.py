...
class RouteEntryForDescribeRouteEntryListOutput(object):
    ...
    def __init__(self, description=None, destination_cidr_block=None, next_hop_id=None, next_hop_type=None, route_entry_id=None, route_entry_name=None, route_table_id=None, status=None, type=None, vpc_id=None, _configuration=None):  # noqa: E501
