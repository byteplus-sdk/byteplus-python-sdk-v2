...
class PermissionForDescribeSecurityGroupAttributesOutput(object):
    ...
    def __init__(self, cidr_ip=None, creation_time=None, description=None, direction=None, port_end=None, port_start=None, protocol=None, source_group_id=None, update_time=None, _configuration=None):  # noqa: E501
