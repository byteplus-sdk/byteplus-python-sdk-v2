...
class DescribeRouteEntryListRequest(object):
    ...
    def __init__(self, destination_cidr_block=None, max_results=None, next_hop_id=None, next_hop_type=None, next_token=None, page_number=None, page_size=None, route_entry_id=None, route_entry_name=None, route_entry_type=None, route_table_id=None, _configuration=None):  # noqa: E501
