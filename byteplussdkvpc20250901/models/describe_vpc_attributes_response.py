...
class DescribeVpcAttributesResponse(object):
    ...
    def __init__(self, account_id=None, cidr_block=None, creation_time=None, description=None, dns_servers=None, is_default=None, nat_gateway_ids=None, project_name=None, request_id=None, route_table_ids=None, secondary_cidr_blocks=None, security_group_ids=None, status=None, subnet_ids=None, tags=None, update_time=None, vpc_id=None, vpc_name=None, _configuration=None):  # noqa: E501
