...
class SecurityGroupForDescribeSecurityGroupsOutput(object):
    ...
    def __init__(self, account_id=None, creation_time=None, description=None, project_name=None, security_group_id=None, security_group_name=None, service_managed=None, status=None, tags=None, type=None, vpc_id=None, _configuration=None):  # noqa: E501
