...
class RouterTableListForDescribeRouteTableListOutput(object):
    ...
    def __init__(self, account_id=None, associate_type=None, creation_time=None, description=None, project_name=None, route_table_id=None, route_table_name=None, route_table_type=None, subnet_ids=None, tags=None, update_time=None, vpc_id=None, vpc_name=None, _configuration=None):  # noqa: E501
