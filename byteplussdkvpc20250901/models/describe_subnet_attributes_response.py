...
class DescribeSubnetAttributesResponse(object):
    ...
    def __init__(self, account_id=None, available_ip_address_count=None, cidr_block=None, creation_time=None, description=None, is_default=None, project_name=None, request_id=None, route_table=None, status=None, subnet_id=None, subnet_name=None, tags=None, total_ipv4_count=None, update_time=None, vpc_id=None, zone_id=None, _configuration=None):  # noqa: E501
