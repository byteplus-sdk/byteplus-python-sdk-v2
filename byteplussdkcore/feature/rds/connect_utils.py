...
from byteplussdkcore.interceptor import InterceptorChain, InterceptorContext, SignRequestInterceptor, \
    ResolveEndpointInterceptor
from byteplussdkcore.interceptor import Request
...
def build_auth_token(api_client, db_user, instance_id, expires=None):
    """
    Build an authentication token (presigned URL query string) for connecting to RDS MySQL database.
    ...
    :return: Presigned query string for database authentication
