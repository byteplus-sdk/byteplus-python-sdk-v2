...
class StsOidcCredentialProvider(Provider):
    ...
    def __init__(self, role_name=None, account_id=None, oidc_token=None,
                 ...
                 host=None, region='ap-singapore-1', timeout=30,
        ...
        if role_trn:
            ...
            env_trn = os.environ.get("BYTEPLUS_OIDC_ROLE_TRN", "")
        ...
        if not self._legacy_mode:
            self._oidc_token_file = oidc_token_file or os.environ.get("BYTEPLUS_OIDC_TOKEN_FILE", "") or None
        else:
        ...
        if session_name:
            ...
            self._session_name = os.environ.get("BYTEPLUS_OIDC_ROLE_SESSION_NAME", "") or None
        else:
        ...
        if policy is not None:
            ...
            self.policy = os.environ.get("BYTEPLUS_OIDC_ROLE_POLICY") or None
        else:
            self.policy = None
        ...
        if host:
            ...
            self.host = os.environ.get("BYTEPLUS_OIDC_STS_ENDPOINT", "") or "open.byteplusapi.com"
        else:
    ...
    def _resolve_oidc_token(self):
        ...
        if not token_file:
            raise RuntimeError(
                ...
                "or BYTEPLUS_OIDC_TOKEN_FILE environment variable.".format(self.PROVIDER_NAME)
            )
    ...
    def _assume_role_oidc(self):
        if not self._role_trn:
            raise RuntimeError(
                ...
                "or BYTEPLUS_OIDC_ROLE_TRN environment variable.".format(self.PROVIDER_NAME)
            )
