...
class UnsubscribeInstanceRequest(object):
    ...
    def unsubscribe_related_instance(self, unsubscribe_related_instance):
        ...
        :type: bool
        """
        if self._configuration.client_side_validation and unsubscribe_related_instance is None:
            raise ValueError("Invalid value for `unsubscribe_related_instance`, must not be `None`")  # noqa: E501
