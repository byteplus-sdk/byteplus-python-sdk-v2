...
class BILLINGApi(object):
    ...
    def list_bill_detail2(self, body, **kwargs):  # noqa: E501
        """list_bill_detail2  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_bill_detail2(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param ListBillDetail2Request body: (required)
        :return: ListBillDetail2Response
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_bill_detail2_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.list_bill_detail2_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def list_bill_detail2_with_http_info(self, body, **kwargs):  # noqa: E501
        """list_bill_detail2  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_bill_detail2_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_bill_detail2" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if self.api_client.client_side_validation and ('body' not in params or
                                                       params['body'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body` when calling `list_bill_detail2`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/ListBillDetail2/2022-01-01/billing/post/application_json/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='ListBillDetail2Response',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
