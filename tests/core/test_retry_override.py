...
import byteplussdkcore.api_client as api_client_module
from byteplussdkcore import rest
from byteplussdkcore.api_client import ApiClient
from byteplussdkcore.interceptor.interceptors.request import RuntimeOption
...
from byteplussdkcore.retryer.retryer import new_backoff_strategy, new_retry_condition
import byteplussdkbilling
...
class RetryOverrideTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self._orig_default = byteplussdkcore.Configuration._default
        ...
        byteplussdkcore.Configuration._default = None
        self.configuration = byteplussdkcore.Configuration()
    ...
    def tearDown(self):
        ...
        byteplussdkcore.Configuration._default = self._orig_default

    def _call(self, runtime_option=None):
        byteplussdkcore.Configuration.set_default(self.configuration)
        api = byteplussdkbilling.BILLINGApi()
        api.query_balance_acct(byteplussdkbilling.QueryBalanceAcctRequest(_configuration=runtime_option))
